...
/* OTAA para*/
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x33, 0x37 };
uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // joinEUI
uint8_t appKey[] = { 0xF4, 0xA2, 0x40, 0x71, 0xB7, 0xDE, 0x03, 0xCD, 0xD4, 0xC0, 0xAC, 0x2C, 0xDC, 0x21, 0x56, 0xCF };
