...
// The whole sensor suite is connected (temperature, pH, TDS, EC, DO, turbidity).
// Sensors measure data every 60 minutes and that data is then sent to TTN.
// During the sleep phase, the sensors are turned off.
// No re-joins during sleep.
